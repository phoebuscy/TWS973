...
set jvm_opts=-Xdebug -Xrunjdwp:transport=dt_socket,address=%port%,server=y,suspend=n -XXaltjvm=dcevm -javaagent:C:\hotswap\hotswap-agent-1.1.0-SNAPSHOT.jar -Xbootclasspath/a:%otherjar%
